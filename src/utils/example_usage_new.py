"""
Example usage of the Modular Stock Trend Analyzer
...
from output_formatter import print_analysis
...
def analyze_single_stock(symbol):
    ...
    Returns:
        tuple: (trend, analysis) - Trend classification and full analysis data
    """
